            ...
            <div className="container">
                <div className="footer__nav">
                    ...
                    <div className={'footer__svg'}>
                        <Link href="" className="footer__icons hvr-bounce-in" to={''}>
                            <svg className="footer__img footer__img-1" viewBox="0 0 16 16"
                        ...
                        <Link href="" className="footer__icons hvr-bounce-in" to={''}>
                            <svg className="footer__img footer__img-2" viewBox="0 0 16 16"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link href="" className="footer__icons hvr-bounce-in" to={''}>
                            <svg className="footer__img footer__img-3" viewBox="0 0 16 16"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <Link href="" className="footer__icons hvr-bounce-in" to={''}>
                            <svg className="footer__img footer__img-4" viewBox="0 0 16 16"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                        ...
                        <Link href="" className="footer__icons hvr-bounce-in" to={''}>
                            <svg className="footer__img footer__img-5" viewBox="0 0 16 16"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                ...
                <p>© 2021 Playstation. Все права защищены.</p>
            </div>
        </footer>
    );
};
